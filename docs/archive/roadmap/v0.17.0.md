# Archiwum roadmapy v0.17.0 (milestones 0.5–17)

Archiwum zachowuje pełne szczegóły ukończonych milestone'ów 0.5–17. Aktualny plan znajduje się w [`ROADMAP.md`](../../../ROADMAP.md).
